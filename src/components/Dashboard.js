                 ...
                 <div className="row no-gutters align-items-center">
                   <div className="col mr-2">
                     <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                       Earnings (Annual)</div>
                     <div className="h5 mb-0 font-weight-bold text-gray-800">${props.data.data.earningsAnnually}</div>
                   </div>
                   <div className="col-auto">
                     ...
                     <div className="row no-gutters align-items-center">
                       ...
                       <div className="col">
                         <div className="progress progress-sm mr-2">
                           <div className="progress-bar bg-info" role="progressbar" style={{"width": `${props.data.data.task}%`,"ariaValuenow":`${props.data.data.task}`,"ariaValuemin":"0",
               ...
               <div className="card-body">
                 <div className="row no-gutters align-items-center">
                   <div className="col mr-2">
                     ...
                     <div className="h5 mb-0 font-weight-bold text-gray-800">{props.data.data.pendingRequests}</div>
                   </div>
                   <div className="col-auto">
